...
GPIO_PinConfig gpioPinConfigs[] = {
    ...
    /* CONFIG_GPIO_SW_0 : LaunchPad User Button SW2 (Left) */
    GPIOCC32XX_GPIO_13 | GPIO_CFG_IN_PD | GPIO_CFG_IN_INT_RISING,
    /* CONFIG_GPIO_SW_1 : LaunchPad User Button SW3 (Right) */
...
const uint_least8_t CONFIG_GPIO_SW_0_CONST = CONFIG_GPIO_SW_0;
const uint_least8_t CONFIG_GPIO_SW_1_CONST = CONFIG_GPIO_SW_1;
